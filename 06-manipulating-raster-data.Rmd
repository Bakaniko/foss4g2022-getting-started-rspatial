...
```{r 06-manipulating-raster-data-35, purl=FALSE,echo=FALSE, fig.height=7}
tm_shape(srtm_utm) + 
  tm_grid() + 
  tm_raster(style = "cont") + 
  tm_layout(legend.show = FALSE)
...
```{r 06-manipulating-raster-data-38, echo=FALSE, purl=FALSE, message=FALSE, warning=FALSE, fig.width=12}
...
```{r 06-manipulating-raster-data-40, echo=FALSE, purl=FALSE, message=FALSE, warning=FALSE, fig.width=12}
tc1 = tm_shape(srtm_utm) +
  tm_grid() + 
  tm_raster(style = "cont") +
  tm_shape(zion) +
