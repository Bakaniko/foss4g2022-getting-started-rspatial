...
```{r 06-manipulating-raster-data-37, echo=FALSE, purl=FALSE, message=FALSE, warning=FALSE, fig.width=12, eval=FALSE}
...
```{r 06-manipulating-raster-data-39, echo=FALSE, purl=FALSE, message=FALSE, warning=FALSE, fig.width=12, eval=FALSE}
tc1 <- tm_shape(srtm_utm) +
  tm_grid() + 
  tm_raster(style = "cont") +
  tm_shape(zion) +
...
```{r 06-manipulating-raster-data-45, purl=FALSE,echo=FALSE}
tm_shape(srtm) +
  tm_raster(style = "cont") +
  tm_shape(zion) +
  tm_polygons()
