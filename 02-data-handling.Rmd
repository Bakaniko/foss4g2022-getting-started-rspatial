...
As it can be difficult to debug piped commands for the beginners, we won't use it in this workshop.
However, its usage very frequent so it is most likely that a beginner will encounter it soon.
...
In the following example, we show how to compute the mean GDP by decade of the Europeans countries.
...
With R 4.1.0, a built-in piping operator has been introduced:
