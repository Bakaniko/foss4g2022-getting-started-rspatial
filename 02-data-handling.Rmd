...
<!--
summarise(group_by(mutate(gapminder, GDP = (gdpPercap * pop)/ 1000000), continent, country), max_GDP = max(GDP))
-->
...
This new key will be the country name and the year seperated by an underscore.
